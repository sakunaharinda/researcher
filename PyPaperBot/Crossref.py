...
def getPapersInfo(papers, scholar_search_link, restrict, scholar_results, spinner=None):
    # spinner.start("Searching papers on Crossref...")
    papers_return = []
    num = 1
    for paper in papers:
        ...
        spinner.start("Searching paper {} of {} on Crossref...".format(num, len(papers)))
        num += 1
